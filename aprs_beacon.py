...
pressure = inhg_to_mbar(pressure)
...
APRS_String  = aprsCallsign+">APRS,TCPIP*:@"+formatted_utc+"z"+coords+"_"+wind_directionstr+"/"+wind_speedstr+"t"+temperaturestr+"P"+rainfall_since_midnightstr+"h"+humiditystr+"b"+pressurestr+"powered by wunderground.com"
